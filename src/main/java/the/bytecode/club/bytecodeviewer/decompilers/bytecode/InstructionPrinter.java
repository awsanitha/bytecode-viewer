...
public class InstructionPrinter implements Opcodes
{
    ...
    {
        String line = "";
        if (ain instanceof VarInsnNode node)
            line = printVarInsnNode(node);
        else if (ain instanceof IntInsnNode node)
            line = printIntInsnNode(node);
        else if (ain instanceof FieldInsnNode node)
            line = printFieldInsnNode(node);
        else if (ain instanceof MethodInsnNode node)
            line = printMethodInsnNode(node);
        else if (ain instanceof LdcInsnNode node)
            line = printLdcInsnNode(node);
        else if (ain instanceof InsnNode node)
            line = printInsnNode(node);
        else if (ain instanceof JumpInsnNode node)
            line = printJumpInsnNode(node);
        else if (ain instanceof LineNumberNode node)
            line = printLineNumberNode(node);
        else if (ain instanceof LabelNode node)
            line = printLabelNode(node);
        else if (ain instanceof TypeInsnNode node)
            line = printTypeInsnNode(node);
        else if (ain instanceof FrameNode node)
            line = printFrameNode(node);
        else if (ain instanceof IincInsnNode node)
            line = printIincInsnNode(node);
        else if (ain instanceof TableSwitchInsnNode node)
            line = printTableSwitchInsnNode(node);
        else if (ain instanceof LookupSwitchInsnNode node)
            line = printLookupSwitchInsnNode(node);
        else if (ain instanceof InvokeDynamicInsnNode node)
            line = printInvokeDynamicInsNode(node);
